<template>
  ...
  >
    <div v-show="modalOpen" :id="id" class="fixed inset-0 z-30 overflow-hidden flex items-start top-20 mb-4 justify-center px-4 sm:px-6" role="dialog" aria-modal="true">
